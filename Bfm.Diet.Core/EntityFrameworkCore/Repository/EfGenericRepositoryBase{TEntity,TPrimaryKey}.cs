...
{
    public class EfGenericRepositoryBase<TDbContext, TEntity, TPrimaryKey> :
        DietRepositoryBase<TEntity, TPrimaryKey>,
        IEfGenericRepositoryWithDbContext where TEntity : class, IEntity<TPrimaryKey>
